...
const _: () = assert!(127u8 == 0x7fu8 && 128u8 == 0x80u8 && 255u8 == 0xffu8);
...
const _: () = assert!(-128i8 == 0x80u8 as i8 && -1i8 == 0xffu8 as i8 && 127i8 == 0x7fi8);
...
const _: () = assert!(
    128i16 == 0x0080i16
        && 255i16 == 0x00ffi16
        && 127i16 == 0x007fi16
        && -128i16 == 0xff80u16 as i16
        && -1i16 == 0xffffu16 as i16
        && -256i16 == 0xff00u16 as i16
        && -255i16 == 0xff01u16 as i16
        && -129i16 == 0xff7fu16 as i16
);
